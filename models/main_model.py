...
from common.library import tweet_gets, search_condition, save_user, save_tweet, save_hashtag, date_format, get_user, search_infos
import datetime
...
class MainModel(BaseModel):
  ...
  def user_search(self):
    """ユーザー検索画面アンド一覧
    """
    return render_template('main/user_search.html', user_search=True, search_infos=search_infos("si.status = '1'"))

  def tweet_search(self):
    """ツイート検索画面アンド一覧
    """
    return render_template('main/tweet_search.html', tweet_search=True, search_infos=search_infos("si.status = '0'"))
